    ...
    <div>
         <nav>
                        <div className="container px-6 py-3 mx-auto lg:flex lg:justify-between lg:items-center">
                            ...
                            <div className="items-center lg:flex text-gray-800">
                                <div className="flex flex-col lg:flex-row lg:mx-6">
                                    <a
                                        className="my-1 text-sm font-medium text-gray-700 hover:text-blue-500 dark:hover:text-blue-400 lg:mx-4 lg:my-0"
                                        href="/"
                                    >
                                        Home
                                    </a>
